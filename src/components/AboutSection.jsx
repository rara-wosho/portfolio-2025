...
const AboutSection = () => {
    return (
        ...
        >
            ...
            <p
                style={{ lineHeight: 2 }}
                className="mb-0 text-secondary fs-7 mt-3"
            >
            ...
            >
                ...
                front-end development and design. I thrive on crafting
                innovative solutions and creating engaging digital experiences
                that leave a lasting impact. My journey into the world of
                technology began with a fascination for the endless
