...
const TechStack = () => {
    return (
        ...
        >
            ...
            <p className="mb-2 fw-semibold mt-3 text-secondary fs-7">
                Frontend
            </p>
            <div className="row row-cols-4 px-2">
                <div className="col mb-2 px-1">
                    <TechBadge logo="/logo/nextjs.png" label="Next JS" />
                </div>
                <div className="col mb-2 px-1">
            ...
            <div className="row row-cols-4 px-2">
                <div className="col mb-2 px-1">
                    <TechBadge logo="/logo/supabase.png" label="Supabase" />
                </div>
                <div className="col mb-2 px-1">
            ...
            <div className="row row-cols-4 px-2 overflow-hidden">
                <div className="col mb-2 px-1">
                    <TechBadge logo="/logo/images.png" label="Shadcn UI" />
                </div>
                <div className="col mb-2 px-1">
                    <TechBadge logo="/logo/resend.svg" label="Resend" />
                </div>
                <div className="col mb-2 px-1">
